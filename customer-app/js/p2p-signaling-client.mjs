/**
 * Phase 3 — signaling callables for P2P (no SDP logged).
 */
...
export function publishRidePeerAnswerClient(payload) {
  return call("publishRidePeerAnswer", payload);
}
...
/**
 * Document-specific listener for ridePeerSessions/{rideId} — never collection query.
 */
