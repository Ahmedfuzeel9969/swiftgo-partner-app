...
export const LOCATION_MAX_FUTURE_MS = 10_000;
export const LOCATION_MAX_ACCURACY_M = 80;
export const LOCATION_MAX_SPEED_MPS = 45;

export function locationSessionId(value) {
  return typeof value === "string" && /^[A-Za-z0-9_-]{3,64}$/.test(value) ? value : "";
}

export function locationDistanceM(a, b) {
...
export function rideLocationAssignmentVersion(ride) {
...
export function validateRideLocationFix(raw, context = {}) {
