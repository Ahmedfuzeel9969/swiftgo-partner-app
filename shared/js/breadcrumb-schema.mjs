...
export const BREADCRUMB_MAX_BATCH_BYTES = 12_000;
export const BREADCRUMB_MAX_QUEUE_POINTS = 180;
export const BREADCRUMB_MAX_QUEUE_BYTES = 80_000;
export const BREADCRUMB_QUEUE_RETENTION_MS = 2 * 60 * 60_000;
export const BREADCRUMB_MAX_BATCH_SPAN_MS = 10 * 60_000;
export const BREADCRUMB_MAX_POINT_AGE_MS = 30 * 60_000;
export const BREADCRUMB_MAX_FUTURE_SKEW_MS = 30_000;
export const BREADCRUMB_MAX_ACCURACY_M = 100;
export const BREADCRUMB_MIN_SEGMENT_M = 3;
export const BREADCRUMB_MAX_SPEED_MPS = 55;
export const BREADCRUMB_MAX_CONTINUOUS_GAP_MS = 15_000;
 ...
 */
export const BREADCRUMB_MAX_UPLOADS_PER_SCHEDULED_TICK = 1;
 ...
 */
export function validateBreadcrumbPoint(raw, { nowMs = Date.now(), previous = null } = {}) {
 ...
 */
export function validateBreadcrumbBatch(batch, { nowMs = Date.now() } = {}) {
 ...
 */
export function accumulateDenseChordMeters(points, {
  previousAnchor = null,
...
export function estimatePointBytes(point) {
