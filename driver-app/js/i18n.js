...
const dictionaries = {
  en: {
    ...
    pinCopy: "Enter the owner's 12-digit single-use link code. It expires after ten minutes.",
  ...
  ur: {
    ...
    pinCopy: "مالک کا بارہ ہندسوں کا تازہ ربط کوڈ درج کریں۔ یہ دس منٹ میں صرف ایک بار استعمال ہوتا ہے۔",
