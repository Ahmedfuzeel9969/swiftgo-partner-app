...
const dictionaries = {
  en: {
    ...
    statusHomeHintOnline: "Get rides",
    statusHomeHintOffline: "Go online to get rides",
    statusHomeLabelOnline: "Online — ready for rides",
    statusHomeLabelOffline: "Offline — rides closed",
    getRideBtn: "Get a ride",
    searchAria: "Search",
  ...
  ur: {
    ...
    statusHomeHintOnline: "سواری حاصل کریں",
    statusHomeHintOffline: "سواری حاصل کرنے کے لئے آن لائن ہوں",
    statusHomeLabelOnline: "آن لائن — سواری کے لیے تیار",
    statusHomeLabelOffline: "آف لائن — سواری بند",
    getRideBtn: "سواری حاصل کریں",
    searchAria: "تلاش",
