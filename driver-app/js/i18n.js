...
const dictionaries = {
  en: {
    ...
    pinCopy: "Linking a vehicle is optional. Enter the owner’s 4-digit PIN, or skip and link later.",
    ...
    diagnosticsSub: "Field test log — GPS, Firebase, P2P, routing. No laptop console needed.",
    diagnosticsCopy: "Copy Diagnostic Report",
    diagnosticsClear: "Clear",
    diagnosticsLogTitle: "Recent events",
  ...
  ur: {
    ...
    pinCopy: "گاڑی منسلک کرنا اختیاری ہے۔ مالک کا 4 ہندسوں کا PIN درج کریں، یا ابھی چھوڑ کر بعد میں لنک کریں۔",
    ...
    navEarnings: "کمائی",
    navWallet: "والٹ",
    navDiagnostics: "ڈائگنوسٹکس",
    diagnosticsSub: "فیلڈ ٹیسٹ لاگ — GPS، Firebase، P2P، روٹنگ۔ لیپ ٹاپ کنسول کی ضرورت نہیں۔",
    diagnosticsCopy: "ڈائگنوسٹک رپورٹ کاپی کریں",
    diagnosticsClear: "صاف کریں",
    diagnosticsLogTitle: "حالیہ واقعات",
