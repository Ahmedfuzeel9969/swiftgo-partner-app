// Generated from shared/js/location-delivery-policy.mjs; checked byte-for-byte by tests.
"use strict";
 ...
 */
const LOCATION_DELIVERY_FIELDS = Object.freeze({
...
const LOCATION_DELIVERY_KEYS = Object.freeze([
  ...Object.keys(LOCATION_DELIVERY_FIELDS), "firebaseLocationFallbackEnabled",
]);

function validDeliveryValue(key, value) {
...
function normalizeLocationDeliverySettings(raw = {}) {
  const result = {};
...
function locationDeliverySettingsPatch(raw = {}) {
  const patch = {};
...
function resolveLocationDeliveryPolicy(raw = {}) {
...
function normalizeRuntimeDeliveryPolicy(raw = {}, previous = resolveLocationDeliveryPolicy()) {
  const mapping = {
...
module.exports = { LOCATION_DELIVERY_FIELDS, LOCATION_DELIVERY_KEYS, validDeliveryValue, normalizeLocationDeliverySettings, locationDeliverySettingsPatch, resolveLocationDeliveryPolicy, normalizeRuntimeDeliveryPolicy };
